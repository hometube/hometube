...
const doImport = async () => {
  ...
  try {
    ...
    result.value = isLocalMode()
      ? 'Import completed successfully. Navigate to browse your imported content.'
      : 'Import completed successfully. Data has been uploaded to the server.'
