...
}, b = (a) => [f.prefix, a, f.suffix].filter((e) => e && e.length > 0).join("-"), N = (a) => {
...
const W = "GET", R = (a) => a && typeof a == "object" ? a : { handle: a };
class w {
  /**
...
let y;
const X = () => (y || (y = new Q(), y.addFetchListener(), y.addCacheListener()), y);
function Y(a, e, t) {
  let s;
  if (typeof a == "string") {
...
ne([{"revision":"1872c500de691dce40960bb85481de07","url":"registerSW.js"},{"revision":"976893ec4dd8e24bc7b9536e0c8d971d","url":"index.html"},{"revision":"3219c0f0287179367a8e2d0378c15101","url":"assets/index-tAYKzxBO.js"},{"revision":"e54fc159e0e43d2aec95714423b0f41c","url":"assets/index-B7YUKskK.css"},{"revision":"557b99208de7588695a2db665d5aacdf","url":"icon-64.png"},{"revision":"7b9ea93fd11e4bcf366a72ff2495e3d7","url":"icon-128.png"},{"revision":"cdd7529a0b301a3cfeaffa7385173241","url":"icon-192.png"},{"revision":"48036ab3cad9664c450080c00c2947cf","url":"icon-256.png"},{"revision":"244edb6f8a2f2d185e99595bca38226d","url":"icon-512.png"},{"revision":"5c2213d0e58601cb829c97c9d3e06e50","url":"manifest.webmanifest"}]);
let C = null, L = null;
...
self.addEventListener("message", (a) => {
  var e, t;
  console.log("[SW] Message received:", a.data), ((e = a.data) == null ? void 0 : e.type) === "SET_JWT" && (C = a.data.token, console.log("[SW] JWT updated:", C ? "present" : "empty")), ((t = a.data) == null ? void 0 : t.type) === "SET_BACKEND_URL" && (L = a.data.url, console.log("[SW] Backend URL updated:", L));
});
self.addEventListener("fetch", (a) => {
  const e = new URL(a.request.url);
  if (e.pathname.startsWith("/api/"))
    if (console.log("[SW] Intercepted API request:", e.pathname + e.search), C) {
      console.log("[SW] Adding Authorization header");
      const t = new Headers(a.request.headers);
      t.set("Authorization", `Bearer ${C}`), t.set("ngrok-skip-browser-warning", "true");
      const s = new URL(a.request.url, L), n = new Request(s, {
        headers: t
      });
      console.log("[SW] Modified request:", n), a.respondWith(
        fetch(n).catch((r) => {
          throw console.error("[SW] Fetch failed:", r), r;
        })
      );
    } else
